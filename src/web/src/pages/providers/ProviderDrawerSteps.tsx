...
export type ProviderStepId = 'type' | 'basic' | 'auth' | 'models'
...
export const PROVIDER_STEPS: Array<{ id: ProviderStepId; labelKey: string }> = [
  { id: 'type', labelKey: 'providers.drawer.steps.type' },
  { id: 'basic', labelKey: 'providers.drawer.steps.basic' },
  { id: 'auth', labelKey: 'providers.drawer.steps.auth' },
  { id: 'models', labelKey: 'providers.drawer.steps.models' }
]
...
export function TypeStep({ form, onTypeChange }: ProviderStepShared) {
