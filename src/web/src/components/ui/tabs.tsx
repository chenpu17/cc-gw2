...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-11 items-center justify-center rounded-full border border-border/70 bg-background/70 p-1 text-muted-foreground shadow-[0_1px_2px_rgba(15,23,42,0.03)]',
      className
    )}
    {...props}
  />
